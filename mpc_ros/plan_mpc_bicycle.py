...
class MPC_CBF_Bicycle:
    def __init__(self, dt ,N, v_lim, delta_lim, L,   
                 Q, R, cbf_const, 
    ...
    def setup(self):
        ...
        controls = casadi.vertcat(v, delta)
        ...
        R = casadi.diagcat(self.R_v, self.R_delta)
...
def main(args=None):
    ...
    mpc_cbf = MPC_CBF_Bicycle(dt,N, v_lim, delta_lim, L, Q, R, obstacles= obs_list, cbf_const=True)
